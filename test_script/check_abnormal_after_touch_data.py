...
# -*- coding: utf-8 -*-
"""
检查SPMID文件中播放音轨的异常触后数据 (After Touch Data)
...
def main():
    """主函数"""
    if len(sys.argv) < 2:
        print("用法: python check_abnormal_after_touch_data.py <SPMID文件路径>")
        print("示例: python check_abnormal_after_touch_data.py example.spmid")
        sys.exit(1)
