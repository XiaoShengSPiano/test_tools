...
- **说明**：与平均误差（ME）的区别在于，MAE 不考虑方向性，只反映误差的幅度大小
...
- **平均误差（ME）**：
  \[
  \mathrm{ME} = \frac{1}{n} \sum_{i=1}^{n} x_i
  \]
- **均方误差（MSE）**：
  \[
